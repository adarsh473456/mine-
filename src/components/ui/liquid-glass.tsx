...
// SVG Filter — must be rendered once in the DOM
...
export const GlassButton: React.FC<{
  ...
  <GlassEffect
    href={href}
    className={`rounded-3xl px-8 py-5 hover:px-9 hover:py-6 overflow-hidden ${className}`}
  >
    <div
...
// Glass Card — for supplier cards, modals, sidebars, etc.
export const GlassCard: React.FC<{
  children: React.ReactNode;
  className?: string;
  style?: React.CSSProperties;
}> = ({ children, className = "", style = {} }) => (
  <GlassEffect className={`rounded-2xl p-5 ${className}`} style={style}>
    {children}
  </GlassEffect>
);

// Full-page showcase demo
